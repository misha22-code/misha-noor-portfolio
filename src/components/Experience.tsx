      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-left">
        ...
        <div className="flex flex-col gap-2 mb-12">
          ...
          <p className="text-slate-400 text-sm leading-relaxed mt-1">
            Building modern web applications, AI systems, APIs, and automation
            ...
            >
              ...
              <ul className="flex flex-col gap-3">
                {xp.bullets.map((bullet, bIdx) => (
                  <li
                    key={bIdx}
                    className="flex gap-2.5 items-start text-xs sm:text-[13px] text-slate-350 leading-relaxed font-sans"
                  >
                    <CheckCircle2
                      size={14}
                      className="text-emerald-500/50 shrink-0 mt-0.5"
                    />
                    <span>{bullet}</span>
                  </li>
                ))}
